...
class UserPlayerDetailedScreen extends StatelessWidget {
  ...
  UserPlayerDetailedScreen({super.key, required this.userId});

  @override
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      controller.fetchStatsUserManagement(userId, 'player');// ✅ Now matches method name
    });
                        ...
                        children: [
                          ...
                          recentSessions.isNotEmpty
                            ...
                            child: Column(
                              ...
                              : _buildNoSessionsWidget("No sessions played yet"),
