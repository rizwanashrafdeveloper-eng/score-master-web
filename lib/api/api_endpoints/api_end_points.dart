...
//  static const String facilitatorManagementStat = '$baseUrl/user/1/facilitator-stats';
 // static String facilitatorManagementStat(int userId) => '$baseUrl/user/$userId/facilitator-stats';
  ...
  static String userManagementStat(int userId, String role) {
    switch (role.toLowerCase()) {
      case 'player':
        return '$baseUrl/user/$userId/stats';
      case 'facilitator':
        return '$baseUrl/user/$userId/facilitator-stats';
      case 'admin':
      case 'administrator':
        return '$baseUrl/user/$userId/admin-stats'; // Adjust if needed
      default:
        return '$baseUrl/user/$userId/stats'; // fallback
    }}
//static String userManagementStat(int userId) => '$baseUrl/user/$userId/stats';
}
