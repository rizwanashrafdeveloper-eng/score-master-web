...
class TeamRank {
  final int rank;
  final int sessionId;
  final String sessionDescription; // API returns this, not teamName
  final int totalPoints;

  // Add computed getter for UI compatibility
  String get teamName => sessionDescription.isNotEmpty
      ? sessionDescription
      : "Session $sessionId";
  ...
  // For backward compatibility - score property
